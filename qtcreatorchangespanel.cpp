#include "qtcreatorchangespanelconstants.h"
#include "qtcreatorchangespaneltr.h"
...
namespace QtCreatorChangesPanel::Internal {

class QtCreatorChangesPanelPlugin final : public ExtensionSystem::IPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QtCreatorPlugin" FILE "QtCreatorChangesPanel.json")

public:
    QtCreatorChangesPanelPlugin() = default;

    ~QtCreatorChangesPanelPlugin() final
    {
    ...
    void initialize() final
    {
        ...
        menu->menu()->setTitle(Tr::tr("QtCreatorChangesPanel"));
        ActionManager::actionContainer(Core::Constants::M_TOOLS)->addMenu(menu);

        ActionBuilder(this, Constants::ACTION_ID)
            .addToContainer(Constants::MENU_ID)
            .setText(Tr::tr("QtCreatorChangesPanel Action"))
            .setDefaultKeySequence(Tr::tr("Ctrl+Alt+Meta+A"))
            .addOnTriggered(this, &QtCreatorChangesPanelPlugin::triggerAction);
    }
...
private:
    void triggerAction()
    {
        QMessageBox::information(ICore::dialogParent(),
                                 ...
                                 Tr::tr("This is an action from QtCreatorChangesPanel."));
    }
};

} // namespace QtCreatorChangesPanel::Internal

#include <qtcreatorchangespanel.moc>
